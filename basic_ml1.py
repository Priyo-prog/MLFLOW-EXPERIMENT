...
def main(alpha, l1_ratio):
        ...
        with mlflow.start_run(run_name="ML_RUN"):
            ...
            joblib.dump(value=model, filename=Path("saved_models/regression_model.pkl"))
            mlflow.log_artifact("saved_models", "Regression Model")

if __name__ == "__main__":
     args = argparse.ArgumentParser()
     args.add_argument("--alpha", "-p", type=float, default=0.4)
     args.add_argument("--l1_ratio", "-l1", type=float, default=0.2)
     parsed_args = args.parse_args()

     # Now pass the arguements to main function
